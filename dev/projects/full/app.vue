		...
		<div class="row" style="margin: 10px 0;">
			<div class="col-md-10 col-md-offset-1 text-right">
				<div class="btn-group" role="group" aria-label="Mode toggle">
					<button type="button" class="btn btn-default" :class="{ active: legacyMode }" @click="legacyMode = true">Legacy</button>
					<button type="button" class="btn btn-default" :class="{ active: !legacyMode }" @click="legacyMode = false">Minimal</button>
				</div>
			</div>
		</div>
		<div v-show="model" class="row">
			<div class="col-md-5 col-md-offset-1">
				...
				<div class="errors text-center">
					<div v-for="(item, index) in validationErrors" :key="index" class="alert alert-danger">
						{{ item.field.label }}:
